/* 
	...
	Derived from: Raspberry Pi, Assembly Language, Bruce Smith; which is based on BCM2835 so some modifications are required
...
main:
	...
	bl open_file 
	str r0, [sp, #0] 			// store file handler on 1st level of stack  
	bl map_file
	str r0, [sp, #8]			// store virt GPIO mem address on 3rd level of stack 
...
map_file:
	push {r1-r3, lr}
	str r0, [sp, #0]			// store returned file handle on 1st level of stack
